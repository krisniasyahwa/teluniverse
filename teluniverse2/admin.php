...
<body>
  ...
  <!-- <button type="submit" name="logout">Logout</button> -->
          ...
          <li><a><button onclick="document.location='addBiodata.php'">
                Account
              </button></a></li>
        </ul>
      </div>
  ...
  <section class="product"> 
    ...
    <div class="product-card" href="addEvent.html">
        <button class="product-image" type="submit" name="addevent" href="addEvent.html" onclick="document.location='addEvent.html'">
            <img src="img/winners.png" class="product-thumb" alt="">
            <h2 class="product-brand">add event</h2>
        </button>
      </div>
